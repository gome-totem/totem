...
public class Classes {
    ...
    public static <T> Class<? extends T> loadClass(ClassLoader classLoader, String className, String prefixPackage, String suffixClassName, String errorPrefix) {
        ...
        try {
			throw new Exception(errorPrefix + " with value [" + className + "]; tried " + Arrays.toString(classNames), t);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
    ...
    private static String[] classNames(String className, String prefixPackage, String suffixClassName) {
        ...
        return new String[]{
                className,
                prefixValue + Strings.capitalize(Strings.toCamelCase(classNameValue)) + suffixClassName,
                prefixValue + Strings.toCamelCase(classNameValue) + "." + Strings.capitalize(Strings.toCamelCase(classNameValue)) + suffixClassName,
                prefixValue + Strings.toCamelCase(classNameValue).toLowerCase(Locale.ROOT) + "." + Strings.capitalize(Strings.toCamelCase(classNameValue)) + suffixClassName,
        };
    }
