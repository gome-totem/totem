...
/**
 * This (return) datatype is used as a return-value when returning Event extras data.
 * 
 * <p>Java class for EventExtraType complex type.
 * 
...
@XmlType(name = "EventExtraType", propOrder = {
    "name",
    "explanation",
    "options",
    "inputtype",
