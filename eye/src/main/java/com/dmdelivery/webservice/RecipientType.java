...
/**
 * This datatype represents a recipient. It consists of a number of name/value pairs. Use 'getRecipientFields' to find out what field names you can expect. Used when retrieving recipients.
 * 
