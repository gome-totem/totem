...
public interface DMdeliverySoapAPIPort {
     ...
     * @param groupIDs
     * @return
     *     returns com.dmdelivery.webservice.RecordResultType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public RecordResultType addOverallRecipient(
        @WebParam(name = "login", partName = "login")
        DMdeliveryLoginType login,
        @WebParam(name = "campaignIDs", partName = "campaignIDs")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.BrandArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.CampaignArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.SenderAddressArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param recipientID
     * @return
     *     returns com.dmdelivery.webservice.RecipientCampaignArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.RecipientArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param lang
     * @return
     *     returns com.dmdelivery.webservice.RecipientFieldArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public RecordResultType sendMailing(
        ...
        @WebParam(name = "groupIDs", partName = "groupIDs")
        ArrayOfIntType groupIDs,
        @WebParam(name = "filterID", partName = "filterID")
        int filterID,
    ...
    public RecordResultType sendMailingScheduled(
        ...
        @WebParam(name = "mailingID", partName = "mailingID")
        int mailingID,
        @WebParam(name = "sendDate", partName = "sendDate")
        String sendDate,
        @WebParam(name = "isTest", partName = "isTest")
        boolean isTest,
        @WebParam(name = "resultsEmail", partName = "resultsEmail")
        ...
        @WebParam(name = "callbackUrl", partName = "callbackUrl")
        String callbackUrl,
        @WebParam(name = "approvalGroupID", partName = "approvalGroupID")
        int approvalGroupID,
        @WebParam(name = "approvalPeriod", partName = "approvalPeriod")
        float approvalPeriod,
        @WebParam(name = "approvalAck", partName = "approvalAck")
        int approvalAck,
        @WebParam(name = "approvalNack", partName = "approvalNack")
        int approvalNack);
     ...
     * @param recipientID
     * @return
     *     returns com.dmdelivery.webservice.ArrayOfIntType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public int moveRecipientsToGroup(
        ...
        @WebParam(name = "campaignID", partName = "campaignID")
        int campaignID,
        @WebParam(name = "fromGroupID", partName = "fromGroupID")
        int fromGroupID,
        @WebParam(name = "toGroupID", partName = "toGroupID")
        int toGroupID);
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.MailingArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.SMSMailingArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public RecipientArrayType getRecipientsFromGroup(
        ...
        @WebParam(name = "inGroupID", partName = "inGroupID")
        int inGroupID,
        @WebParam(name = "fromDate", partName = "fromDate")
        XMLGregorianCalendar fromDate,
        @WebParam(name = "mailingIDs", partName = "mailingIDs")
    ...
    public RecipientArrayType getRecipients(
        ...
        @WebParam(name = "fields", partName = "fields")
        ArrayOfStringType fields,
        @WebParam(name = "inGroupIDs", partName = "inGroupIDs")
        ArrayOfIntType inGroupIDs,
        @WebParam(name = "notInGroupIDs", partName = "notInGroupIDs")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.MailingStatsSummaryResultType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.GroupArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param types
     * @return
     *     returns com.dmdelivery.webservice.MailingResponseArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public MailingResponseArrayType getMailingResponse(
        ...
        @WebParam(name = "mailingID", partName = "mailingID")
        int mailingID,
        @WebParam(name = "types", partName = "types")
        String types,
        @WebParam(name = "field", partName = "field")
        String field);
    ...
    public String addRecipientAttachment(
        ...
        String fileName,
        @WebParam(name = "fileMD5", partName = "fileMD5")
        String fileMD5,
    ...
    public RecordResultType deleteMailingAttachments(
        ...
        @WebParam(name = "mailingID", partName = "mailingID")
        int mailingID,
        @WebParam(name = "attachmentIDs", partName = "attachmentIDs")
     ...
     * @param groupIDs
     * @return
     *     returns com.dmdelivery.webservice.AddRecipientsResultType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public AddRecipientsResultType addRecipientsSendSMS(
        ...
        @WebParam(name = "campaignID", partName = "campaignID")
        int campaignID,
        @WebParam(name = "SMSmailingID", partName = "SMSmailingID")
        int smSmailingID,
        @WebParam(name = "groupIDs", partName = "groupIDs")
        ArrayOfIntType groupIDs,
        @WebParam(name = "recipientDatas", partName = "recipientDatas")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.EventArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.NewRecipientType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.NewRecipientArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
     ...
     * @param login
     * @return
     *     returns com.dmdelivery.webservice.FilterArrayType
     */
    @WebMethod(action = "urn:DMdeliveryAction")
    ...
    public RecordResultType createSenderAddress(
        @WebParam(name = "login", partName = "login")
        DMdeliveryLoginType login,
        @WebParam(name = "fromEmail", partName = "fromEmail")
        String fromEmail);
    ...
    public RecordResultType createCampaign(
        ...
        String name,
        @WebParam(name = "defaultSenderName", partName = "defaultSenderName")
        String defaultSenderName,
        @WebParam(name = "defaultSenderAddress", partName = "defaultSenderAddress")
        int defaultSenderAddress,
        @WebParam(name = "defaultReplyAddress", partName = "defaultReplyAddress")
        int defaultReplyAddress,
        @WebParam(name = "langs", partName = "langs")
        String langs,
        @WebParam(name = "isOverall", partName = "isOverall")
        boolean isOverall,
        @WebParam(name = "conversionPoints", partName = "conversionPoints")
        String conversionPoints,
        @WebParam(name = "localDomain", partName = "localDomain")
        String localDomain,
        @WebParam(name = "excludeLists", partName = "excludeLists")
        String excludeLists);
    ...
    public RecordResultType copyFieldDefinition(
        @WebParam(name = "login", partName = "login")
        DMdeliveryLoginType login,
        @WebParam(name = "srcCampaignID", partName = "srcCampaignID")
        int srcCampaignID,
        @WebParam(name = "dstCampaignID", partName = "dstCampaignID")
        int dstCampaignID);
