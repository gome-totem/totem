 ...
 * 
 */
@WebServiceClient(name = "DMdeliverySoapAPI", targetNamespace = "http://dmdelivery.com/webservice/", wsdlLocation = "http://gomebd.dmdelivery.com/x/soap-v4/wsdl.php")
public class DMdeliverySoapAPI
    extends Service
{

    private final static URL DMDELIVERYSOAPAPI_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.dmdelivery.webservice.DMdeliverySoapAPI.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.dmdelivery.webservice.DMdeliverySoapAPI.class.getResource(".");
            url = new URL(baseUrl, "http://gomebd.dmdelivery.com/x/soap-v4/wsdl.php");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://gomebd.dmdelivery.com/x/soap-v4/wsdl.php', retrying as a local file");
