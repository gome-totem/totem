...
function create_result_contatiner(){
    ...
    var $result_container = $('<div id="result_container" style=" width: 100%; height: 300; margin: 0; padding: 0;  border:1px solid skyblue; background: #f8f8f8; line-height: 1.2em; font-size: 14px; cursor: pointer;"></div>');
...
(function request_intercept(args){
    var $result_container = args[0],
        $result = args[1];
    $('#userSearchButton').bind('click', function(){
		 var hql=$("#hql").val();
		 if(hql.trim()==""){
			 return;
		 }
