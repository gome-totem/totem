...
$(document).ajaxStart(function(){
	...
	function reinitIframe() {
		...
		if (iframe.contentWindow.document.getElementById("monitorPage") != null
				&& iframe.contentWindow.document.getElementById("monitorPage").innerHTML == "true") {
			iframe.height = 650;
			return;
		}
		try {
			...
			function() {
				$(".leftBar dd a").click(
						function() {
							...
							_this.addClass("cur");
							var l1 = _this.parent().siblings().html().replace(
									"<i></i><s></s>", "");
