...
public class StringInputStream extends InputStream {
	...
	/**
	 * Reads from the Stringreader, returning the same value. Note that data
	 * will be lost for characters not in ISO Latin 1. Clients assuming a return
	 * value in the range -1 to 255 may even fail on such input.
	 * 
